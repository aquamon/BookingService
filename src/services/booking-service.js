...
class BookingService{
    ...
    async createBooking(data){
       try{
            ...
            //Based upon this flightId Flight will be fetched from the Flight Service
            ...
            axios.patch(updateFlightRequestURL , {totalSeats : flightData.totalSeats - booking.noOfSeats});
